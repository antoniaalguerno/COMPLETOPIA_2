...
export const EditUser: React.FC = () => {
    ...
    useEffect(() => {
        const fetchUser = async () => {
            try {
                ...
                // Actualiza las opciones de comunas según la región existente
                if (data.region) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await axios.put(
                `http://127.0.0.1:8000/api/administrator/users/${userId}/edit/`,
                formData,
                {
                    headers: {
            ...
            <form className="user-form-card" onSubmit={handleSubmit}>
                <div className="form-grid">
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" id="first_name" value={userData.first_name} onChange={handleInputChange} />
                    </div>
                    <div className="form-group">
                        <label htmlFor="last_name">Apellido</label>
                        <input type="text" id="last_name" value={userData.last_name} onChange={handleInputChange} />
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                        ...
                        <input type="tel" id="mobile" value={userData.mobile} onChange={handleInputChange} />
                    </div>
                    <div className="form-group span-2">
                        <label htmlFor="direccion">Dirección</label>
                        <input type="text" id="direccion" value={userData.direccion} onChange={handleInputChange} />
                    </div>
